        ...
        for layer_n in range(self.nLayers):
            ...
            for comb in range(self.combs):
                ...
                for env in range(self.envelope):
                    ...
                    print self.subap_layer_diameters[layer_n, 0, comb, env]
            ...
            print self.covariance_slice * self.radSqaured_to_arcsecSqaured
            print r0_scale
...
if __name__ == '__main__':
    ...
    telDiam = 4.2
    gsAlt = numpy.array([0]*nwfs)
    gsPos = numpy.array([[0.,-20.], [0.,20], [0,10]])#, [50,50], [-5, -5]])
    wfsWavelength = numpy.array([500e-9]*nwfs)
